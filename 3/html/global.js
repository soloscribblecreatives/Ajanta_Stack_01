...
function set_pg_content(pg_id){
	...
	switch(pg_id){
		...
		case 1:
		content='<div class="aSlide1"> <img src="slide1/bg.png" width="1366" height="1024" alt="" class="bg"> <img src="slide1/01-element.png" class="view1 animated fadeInUp" alt=""> <img src="slide1/02-element.png" class="view2 animated fadeIn" alt=""> <img src="slide1/03-element.png" class="view3 animated fadeInUp" alt=""> <img src="slide1/04-element.png" class="view4 animated fadeInUp" alt=""> <img src="slide1/05-element.png" class="view5 animated fadeInLeft" alt=""><img src="slide1/06-element.png" class="view6 animated fadeInLeft" alt=""> <img src="slide1/07-element.png" class="view7 animated fadeInRight" alt="">  <img src="slide1/08-element.png" class="view8 animated fadeInRight" alt="">  </div>';
		break;
		case 2:
		content='<div class="aSlide2"> <img src="slide2/bg.png" width="1366" height="1024" alt="" class="bg"> <img src="slide2/01-element.png" class="view1 animated fadeInUp" alt=""> <img src="slide2/02-element.png" class="view2 animated fadeIn" alt=""> <img src="slide2/03-element.png" class="view3 animated fadeInUp" alt=""> <img src="slide2/04-element.png" class="view4 animated fadeInDown" alt=""> <img src="slide2/05-element.png" class="view5 animated fadeInLeft" alt=""><img src="slide2/06-element.png" class="view6 animated fadeInRight" alt=""> <img src="slide2/07-element.png" class="view7 animated fadeInRight" alt="">  <img src="slide2/08-element.png" class="view8 animated fadeInRight" alt="">  </div>';
		break;
	}
...
function checkClickThrough(){
	...
	if(currentslide == 1){
		document.getElementById("click_through").innerHTML='<div id="buttons"><button name="button" style="opacity: 0.0;position:absolute; left:392px; top:300px; z-index:105; width:250px; height:250px;" value="OK" onclick="checkBtns(1)"></button></div>';
	}
	if(currentslide == 2){
		document.getElementById("click_through").innerHTML='<div id="buttons"><button name="button" style="opacity: 0.0;position:absolute; left:40px; top:100px; z-index:105; width:500px; height:207px;" value="OK" onclick="checkBtns(2)"></button><button name="button" style="opacity: 0.0;position:absolute; left:50%; top:55px; z-index:105; width:500px; height:207px;" value="OK" onclick="checkBtns(3)"></button><button name="button" style="opacity: 0.0;position:absolute; left:30%; top:530px; z-index:105; width:500px; height:207px;" value="OK" onclick="checkBtns(4)"></button></div>';
	}
}
